                                ...
                                <div class="flex justify-center py-4 lg:pt-4 pt-8">
                                    <div class="mr-4 p-3 text-center">
                                        <span
                                            ...
                                            class="text-sm text-blueGray-400">Applications</span>
                                    </div>
                                    <div class="mr-4 p-3 text-center">
                                        <span
                                            class="text-xl font-bold block uppercase tracking-wide text-blueGray-600">10</span><span
                                            class="text-sm text-blueGray-400">Saved</span>
                                    </div>
                                            ...
                                            <div
                                                ...
                                                <div class="flex items-center justify-between mt-3">
                                                    ...
                                                    <div class="flex items-center space-x-2">
                                                        <form
                                                            action="{{ route('user.educations.destroy', $education->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('delete')
                                                            <button type="submit">
                            ...
                            <div class="grid gap-4 mx-4 sm:grid-cols-12">
                                ...
                                <div class="relative col-span-12 px-4 space-y-6 sm:col-span-9">
                                    <div
                                        ...
                                        @foreach ($experiences as $experience)
                                            <div
                                                ...
                                                <div class="flex items-center justify-between mt-3">
                                                    ...
                                                    <div class="flex items-center space-x-2">
                                                        <form
                                                            action="{{ route('user.experiences.destroy', $experience->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('delete')
                                                            <button type="submit">
                                                        ...
                                                        <button
                                                            onclick="openUpdateModal('{{ route('user.experiences.edit', $experience->id) }}')"
                                                            class="btn">
                                                            <lord-icon src="https://cdn.lordicon.com/ylvuooxd.json"
                                                                colors="primary:#FFF,secondary:#000000,tertiary:#8B5CF6,quaternary:#8B5CF6"
                                                                trigger=""
                                        ...
                                        @endforeach
>>>>>>> 57651d87e88b6cc16d55d8647da6ff2141c74dc9
                                    </div>
                                </div>
                            </div>
                        </div>
