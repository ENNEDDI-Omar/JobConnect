          ...
          <div class="divide-y dark:divide-gray-700">
            <ul class="pt-2 pb-4 space-y-1 text-sm">
              <li class="dark:bg-gray-800 dark:text-gray-50">
                <a rel="noopener noreferrer" href="dashboard" class="flex items-center p-2 space-x-3 rounded-md">
              ...
              <li>
                <a rel="noopener noreferrer" href="{{route('admin.company.index')}}" class="flex items-center p-2 space-x-3 rounded-md">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 fill-current dark:text-gray-400">
