            ...
            <div class="h-full p-3 space-y-2 w-60 dark:bg-gray-900 dark:text-gray-100">
                ...
                <div class="divide-y dark:divide-gray-700">
                    <ul class="pt-2 pb-4 space-y-1 text-sm">
                        ...
                        <li>
                            <a rel="noopener noreferrer" href="{{ route('admin.company.index') }}"
                                class="flex items-center p-2 space-x-3 rounded-md">
                        ...
                        <li>
                            <a rel="noopener noreferrer" href="#"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                                    class="w-5 h-5 fill-current dark:text-gray-400"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                    <path
