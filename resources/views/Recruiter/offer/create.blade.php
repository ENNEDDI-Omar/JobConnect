...
@section('content')
    <div class="flex justify-center">
        <div class="w-full max-w-md">
            <form action="{{ route('recruiter.offers.store') }}" method="post" enctype="multipart/form-data"
                ...
                <!-- Assurez-vous de définir $categoryId dans votre contrôleur -->
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="location" id="title"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="contract_type" id="title"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="experience" id="title"
