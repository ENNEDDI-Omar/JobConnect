		...
		dark:text-gray-400 rounded-r-lg overflow-y-auto">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="#" class="relative">
                        ...
                        <span>
                            <svg class="h-5 w-5 hover:text-red-600 dark-hover:text-red-400" viewBox="0 0 24 24"
                        ...
                        <div class="absolute w-2 h-2 left-0 mb-6 ml-2 bottom-0">
                            <span class="px-2 py-1 bg-red-600 rounded-full text-white
						text-xs">
                                7
                            </span>
                        </div>
