        ...
        @foreach ($myOffers as $offer)
            <div class="transition-all duration-150 flex w-full px-4 py-6 md:w-1/2 lg:w-1/3">
                ...
                <div
                    ...
                    <a href="{{ route('recruiter.offers.show', $offer) }}" class="w-full">
                    ...
                    <section class="px-4 py-2 mt-2">
                        ...
                        <div class="flex items-center justify-between px-4 py-2 overflow-hidden">
                            ...
                            <a href="{{ route('recruiter.offers.edit', $offer) }}"
                                class="bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600">Modifier</a>

                            <!-- Bouton de suppression -->
                            <form action="{{ route('recruiter.offers.destroy', $offer) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
